...
import { createDesktopHttpAdapter } from './desktop-http-adapter'
import { isTauriDesktop } from '@/utils/desktop-env'

// ==================== Axios Instance Configuration ====================

const API_BASE_URL = resolveApiBaseUrl()
const DESKTOP_HTTP_ADAPTER = isTauriDesktop() ? createDesktopHttpAdapter() : undefined

export const apiClient: AxiosInstance = axios.create({
  baseURL: API_BASE_URL,
  ...(DESKTOP_HTTP_ADAPTER ? { adapter: DESKTOP_HTTP_ADAPTER } : {}),
